...
public:
    ...
    void static BundleAdjustmentWithLine2(const std::vector<KeyFrame*> &vpKF, const std::vector<MapPoint*> &vpMP, const std::vector<MapLine*> &vpML,
                                          int nItertions = 5, bool *pbStopFlag = NULL, const unsigned long nLoopKF=0,
                                          const bool bRobust = true);
    ...
    void static FullInertialBAwithLine(Map *pMap, int its, const bool bFixLocal=false, const unsigned long nLoopKF=0, bool *pbStopFlag=NULL, bool bInit=false, float priorG = 1e2, float priorA=1e6, Eigen::VectorXd *vSingVal = NULL, bool *bHess=NULL);
    ...
    void static LocalBundleAdjustmentwithLine(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF);
    ...
    void static MergeInertialBAWithLine(KeyFrame* pCurrKF, KeyFrame* pMergeKF, bool *pbStopFlag, Map *pMap, LoopClosing::KeyFrameAndPose &corrPoses);
