...
class EdgeLineProjectXYZ2 : public g2o::BaseBinaryEdge<3,Eigen::Vector3d,g2o::VertexSBAPointXYZ,g2o::VertexSE3Expmap> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
    EdgeLineProjectXYZ2() {}
    ...
    virtual void computeError() {
        ...
        Eigen::Vector2d proj = pCamera->project(v1->estimate().map(v2->estimate()));
    ...
    virtual void linearizeOplus() {
        ...
        double fx = pCamera->getParameter(0);
        double fy = pCamera->getParameter(1);
        double cx = pCamera->getParameter(2);
        double cy = pCamera->getParameter(3);
...
class EdgeLineProjectXYZ : public g2o::BaseBinaryEdge<3,Eigen::Vector3d,g2o::VertexSBAPointXYZ,VertexPose> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
    ...
    virtual void computeError() {
        ...
        Eigen::Vector3d obs = _measurement;
        Eigen::Vector2d proj = v1->estimate().Project(v2->estimate());
        _error(0) = obs(0) * proj(0) + obs(1) * proj(1) + obs(2);
        _error(1) = 0;
        _error(2) = 0;
    }
