...
//BOOST_CLASS_EXPORT_GUID(KannalaBrandt8, "KannalaBrandt8")
    ...
    bool KannalaBrandt8::ReconstructWithTwoViewswithLine(const Frame &InitialFrame, const Frame &CurrentFrame,
        ...
        return tvr->ReconstructwithLine(InitialFrame,CurrentFrame,vMatches12,R21,t21,vP3D,vbTriangulated,vLineMatches,vLineS3D,vLineE3D,vbLineTriangulated);
    }
