...
//BOOST_CLASS_EXPORT_GUID(Pinhole, "Pinhole")
    ...
    bool Pinhole::ReconstructWithTwoViewswithLine(const Frame &InitialFrame, const Frame &CurrentFrame,
                                                  const std::vector<int> &vMatches12, cv::Mat &R21, cv::Mat &t21,
                                                  std::vector<cv::Point3f> &vP3D, std::vector<bool> &vbTriangulated,
                                                  vector<pair<int, int>> &vLineMatches, vector<cv::Point3f> &vLineS3D,
